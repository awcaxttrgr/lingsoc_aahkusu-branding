...
\author{}
\title{\includegraphics[height=4cm]{graphics/logotype_spec_1}\\
...
%	\newpage	
	\begin{appendices}
		...
		\includegraphics[height=12.5cm]{graphics/logotype_spec_1}\\
		...
		\textsc{\subsubsection{Colour specifications}}
			\begin{tabbing}
				...
				\includegraphics[height=0.25cm]{graphics/colourchip_blue2} Blue:\> PANTONE 298 U\\  \includegraphics[height=0.25cm]{graphics/colourchip_red2} Red: \> PANTONE Bright Red U\\
